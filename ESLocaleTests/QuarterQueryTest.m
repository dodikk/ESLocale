...
@interface QuarterQueryTest : XCTestCase
@end
...
-(void)testJan1
{
    ...
    XCTAssertTrue( 0 == strcmp( (const char*)result_, "Q1 '11" ), @"raw answer mismatch" );
...
-(void)testApr1
{
    ...
    result_ = sqlite3_column_text( statement_, 0 );
    XCTAssertTrue( 0 == strcmp( (const char*)result_, "Q2 '11" ), @"raw answer mismatch" );
...
-(void)testJuly1
{
    ...
    result_ = sqlite3_column_text( statement_, 0 );
    XCTAssertTrue( 0 == strcmp( (const char*)result_, "Q3 '11" ), @"raw answer mismatch" );
...
-(void)testOct1
{
    ...
    result_ = sqlite3_column_text( statement_, 0 );
    XCTAssertTrue( 0 == strcmp( (const char*)result_, "Q4 '11" ), @"raw answer mismatch" );
