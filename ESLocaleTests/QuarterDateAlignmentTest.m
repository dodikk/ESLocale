...
@interface QuarterDateAlignmentTest : XCTestCase
@end
...
-(void)testPastMay22_2012_QuarterDateResolution
{
    ...
    XCTAssertEqualObjects( result_, @"2012-04-01", @"ok" );
}
...
-(void)testPastOct22_2012_QuarterDateResolution
{
    ...
    XCTAssertEqualObjects( result_, @"2012-10-01", @"ok" );
}
...
-(void)testFutureJan01_2012_QuarterDateResolution
{
    ...
    XCTAssertEqualObjects( result_, @"2012-03-31", @"ok" );
}
...
-(void)testFutureMay22_2012_QuarterDateResolution
{
    ...
    XCTAssertEqualObjects( result_, @"2012-06-30", @"ok" );
}
...
-(void)testFutureSep22_2012_QuarterDateResolution
{
    ...
    XCTAssertEqualObjects( result_, @"2012-09-30", @"ok" );
}
