...
@interface QuarterTest : XCTestCase
@end
...
-(void)testJan1IsInFirstSeason
{
    ...
    XCTAssertTrue( [ result_ isEqualToString: @"Q1 '12" ], @"Q1 expected - %@", result_ );
}
...
-(void)testApril1IsInSecondSeason
{
    ...
    XCTAssertTrue( [ result_ isEqualToString: @"Q2 '12" ], @"Q2 expected - %@", result_ );
}
...
-(void)testJun30IsInSecondSeason
{
    ...
    XCTAssertTrue( [ result_ isEqualToString: @"Q2 '11" ], @"Q2 expected - %@", result_ );
}
...
-(void)testJuly1IsInThirdSeason
{
    ...
    XCTAssertTrue( [ result_ isEqualToString: @"Q3 '12" ], @"Q3 expected - %@", result_ );
}
...
-(void)testOct1IsInFourthSeason
{
    ...
    XCTAssertTrue( [ result_ isEqualToString: @"Q4 '12" ], @"Q4 expected - %@", result_ );
}
